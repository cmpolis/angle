...
(function() {
  ...
  Angle.LineChart = Angle.LineChart = (function(_super) {
    ...
    function LineChart() {
      ...
      _ref = LineChart.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    */
    ...
    LineChart.prototype.initialize = function(options) {
      ...
      _ref1 = ['interpolate', 'yAccessor', 'xAccessor', 'transform'];
      _results = [];
    ...
    */
    ...
    LineChart.prototype.afterFetch = function() {
      ...
      return this.line = d3.svg.line().interpolate(this.interpolate).x(function(d) {
